...
const Customers = () => {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch(
        "https://ecommercebackend-8gx8.onrender.com/get-user"
      );
  ...
  const handleStatusChange = async (userId, newStatus) => {
    try {
      const response = await fetch(
        "https://ecommercebackend-8gx8.onrender.com/update-account-status",
        {
          method: "PUT",
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <Sidebar />
      <div className="flex-1 p-6 lg:p-8 ml-0 lg:ml-64 bg-pink-50 min-h-screen">
