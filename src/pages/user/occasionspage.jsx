...
function SearchInput({ value, onChange }) {
  return (
    <div className="relative w-full sm:w-2/3 md:w-1/2 lg:w-1/3 animate-slideDown">
      <input
        type="text"
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full px-4 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-pink-500 focus:outline-none"
